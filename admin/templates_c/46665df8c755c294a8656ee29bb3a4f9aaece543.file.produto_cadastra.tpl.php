...
<?php /*%%SmartyHeaderCode:134998082253e8b7e544a361-80918243%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46665df8c755c294a8656ee29bb3a4f9aaece543' => 
    array (
  ...
  'nocache_hash' => '134998082253e8b7e544a361-80918243',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'dataAtual' => 0,
    'precoVenda' => 0,
    'precoVendaDataInicial' => 0,
    'precoVendaMarkup' => 0,
    'markup' => 0,
    'precoPromocional' => 0,
    'precoPromocionalDataInicial' => 0,
    'precoPromocionalDataFinal' => 0,
    'produtoPrecoTodos' => 0,
    'valueProdutoPrecoTodos' => 0,
    'listaCategoria' => 0,
  ...
  'unifunc' => 'content_53e8b7e5731ff8_40113043',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53e8b7e5731ff8_40113043')) {function content_53e8b7e5731ff8_40113043($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/Applications/XAMPP/xamppfiles/htdocs/www/lojas/anselmi/smarty/plugins/modifier.capitalize.php';
?>   
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span3 mask-moeda-real" id="precoVendaProduto" type="text" name="precoVendaProduto" value="<?php echo number_format($_smarty_tpl->tpl_vars['precoVenda']->value,2,",",".");?>
" />
                                                </div>
                                            </div>
                                        </div>
                                        <input class="span3 mask-data datepicker" id="precoVendaProdutoDataInicialValidade" type="hidden" name="precoVendaProdutoDataInicialValidade" value="<?php echo $_smarty_tpl->tpl_vars['dataAtual']->value;?>
"/>
                                        <!-- <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="required">Data Inicial Validade</label>
                                                    <input class="span3 mask-data datepicker" id="precoVendaProdutoDataInicialValidade" type="text" name="precoVendaProdutoDataInicialValidade" value="<?php echo $_smarty_tpl->tpl_vars['precoVendaDataInicial']->value;?>
"/>
                                                </div>
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span1 mask-moeda-real" id="precoVendaMarkup" type="text" name="precoVendaMarkup" value="<?php echo $_smarty_tpl->tpl_vars['precoVendaMarkup']->value;?>
"/>
                                                    *Markup Geral R$ <?php echo number_format($_smarty_tpl->tpl_vars['markup']->value,2,",",".");?>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span3 mask-moeda-real" id="precoVendaProdutoVarejo" readonly type="text" name="precoVendaProdutoVarejo" value="<?php echo number_format(($_smarty_tpl->tpl_vars['precoVenda']->value*$_smarty_tpl->tpl_vars['markup']->value),2,",",".");?>
" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span3 mask-moeda-real" id="precoPromocionalProduto" type="text" name="precoPromocionalProduto" value="<?php echo number_format($_smarty_tpl->tpl_vars['precoPromocional']->value,2,",",".");?>
" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span3 mask-moeda-real" id="precoPromocionalProdutoVarejo" readonly type="text" name="precoPromocionalProdutoVarejo" value="<?php echo number_format(($_smarty_tpl->tpl_vars['precoPromocional']->value*$_smarty_tpl->tpl_vars['markup']->value),2,",",".");?>
" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span3" for="required">Data Inicial Validade</label>
                                                    <input class="span3 mask-data datepicker" id="precoPromocionalProdutoDataInicialValidade" type="text" name="precoPromocionalProdutoDataInicialValidade" value="<?php echo $_smarty_tpl->tpl_vars['precoPromocionalDataInicial']->value;?>
"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span3 mask-data datepicker" id="precoPromocionalProdutoDataFinalValidade" type="text" name="precoPromocionalProdutoDataFinalValidade" value="<?php echo $_smarty_tpl->tpl_vars['precoPromocionalDataFinal']->value;?>
"/>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <!--<button type="button" class="btn">Cancelar</button>-->
                                        ...
                                        <table class="responsive table table-condensed">
                                            ...
                                            <tbody>
                                              <?php  $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['produtoPrecoTodos']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                              <tr id="tr<?php echo $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['ID_PRODUTO_PRECO_VENDA'];?>
">
                                                <td><?php echo $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['DESCRICAO'];?>
</td>
                                                <td><?php echo number_format($_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['VALOR'],2,",",".");?>
</td>
                                                <td><?php echo number_format($_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['MARKUP_GERAL'],2,",",".");?>
</td>
                                                <td><?php echo number_format(($_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['VALOR']*$_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['MARKUP_GERAL']),2,",",".");?>
</td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['DATA_INICIAL_VALIDADE'];?>
</td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['DATA_FINAL_VALIDADE'];?>
</td>
                                                 <td><?php echo $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['DATA_INSERT'];?>
</td>
                                                <td>
                                                    <?php if ($_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['DATA_INSERT']==$_smarty_tpl->tpl_vars['dataAtual']->value){?>
                                                    <a href="javascript:removeProdutoPreco(<?php echo $_smarty_tpl->tpl_vars['valueProdutoPrecoTodos']->value['ID_PRODUTO_PRECO_VENDA'];?>
...
"></td>
                                                    <!-- <td><input type="radio" name="produtoPrincipal" id="produtoPrincipal<?php echo $_smarty_tpl->tpl_vars['valueCombinacao1']->value['CODIGO_UNICO'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['valueCombinacao1']->value['CODIGO_UNICO'];?>
" <?php if ($_smarty_tpl->tpl_vars['valueCombinacao1']->value['PRODUTO_PRINCIPAL']=='S'){?>checked="checked"<?php }?>></td> -->
                                                    <td>
