    <div id="wrapper">
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                {foreach $countPedidoPessoa as $valorCountPedidoPessoa}{/foreach}
                            ...
                            <ul class="bigBtnIcon">
                                <li>
                                    <a href="pessoa-lista" class="tipB">
                                        ...
                                        {if $valorCountPedidoPessoa.PESSOAS gt 0}
                                        	<span class="notification">{$valorCountPedidoPessoa.PESSOAS}</span>
                                        {/if}
                                    </a>
                                </li>
                                <!--  <li>
                                ...
                                <li>
                                    <a href="pedido-lista">
                                        ...
                                        {if $valorCountPedidoPessoa.PEDIDOS > 0}
                                        	<span class="notification">{$valorCountPedidoPessoa.PEDIDOS}</span>
                                        {/if}
                                    </a>
                                </li>
                                <!-- <li>
                                    <a href="lista-casamento-lista">
                                        ...
                                        {if $valorCountPedidoPessoa.LISTA_CASAMENTO > 0}
                                            <span class="notification">{$valorCountPedidoPessoa.LISTA_CASAMENTO}</span>
                                        {/if}
                                    </a>
                                </li> -->
                                <!--<li>
                        ...
                        <div class="box chart gradient">
                            ...
                            <div class="title">
                                ...
                                <h4>
                                    ...
                                    <span>Pedidos nos &Uacute;ltimos {$xDias} Dias</span>
                            ...
                            {*}<div class="content" style="padding-bottom:0;">
                               <div class="grafico-pedidos" style="height: 230px;width:100%;margin-top:15px; margin-bottom:15px;"></div>
                               <ul class="chartShortcuts">
                                    <li>
                                        <span class="head">Todos Pedidos</span>
                                        <span class="number">{$nroPedidosVendidos}</span>
                                    </li>
                                    <li>
                                        <span class="head">Considerados Vendidos</span>
                                        <span class="number">{$nroPedidosVendidos}</span>
                                    </li>
                                    <li>
                                        <span class="head">Negados, Cancelados, Devolvidos</span>
                                        <span class="number">{$nroPedidosVendidos}</span>
                                    </li>
...
<!--
    ...
    <script>
        var pedidosDonut = {$JSONpedidos};
        var pedidosChart = {$JSONpedidosDetalhe};
    </script>
