...
$(document).ready(function() {
	...
	$('#btn-geral, .grafico-pedidos-chart').hide();
	$('.btn-toggle').on('click', function(event) {
		event.preventDefault();
		$(this).hide().siblings('.btn-toggle').show();
	...
	if (divElement.hasClass('grafico-pedidos')) {
	$(function () {
		//some data
		var d1 = d1Valores;
		var d2 = d2Valores;
		//define placeholder class
		var placeholder = $(".grafico-pedidos");
		//graph options
		var options = {
				grid: {
					show: true,
			...
			$.plot(placeholder, [
				...
				{
					label: "Considerados Vendidos",
					data: d1,
					lines: {fillColor: "#f2f7f9"},
					points: {fillColor: "#88bbc8"}
				},
				{
					label: "Negados, Cancelados, Devolvidos",
					data: d2,
	...
	if (divElement.hasClass('grafico-pedidos-chart')) {
	$(function () {
		//define placeholder class
		var placeholder = $(".grafico-pedidos-chart");
		//graph options
		var options = {
				grid: {
					show: true,
			...
			$.plot(placeholder, pedidosChart, options);
	...
	//Donut simple chart
	if (divElement.hasClass('grafico-pedidos-donut')) {
	$(function () {
		var data = [
		...
		$.plot($(".grafico-pedidos-donut"), pedidosDonut,
		{
			series: {
				pie: {
					show: true,
