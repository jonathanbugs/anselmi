		...
		<div id="wrapper"> -->
			<div class="containerGeral">
				...
				<header id="topo"></header>
					{include file="../lista-casamento/includes/topo2.tpl"}
					
					{foreach $listaPessoa as $valuePessoa}{/foreach}
					{foreach $listaEndereco as $valueEndereco}{/foreach}
										...
										<div class="blocoConjuge clearfix">
											<div class="blocoConjugeLeft">
												<div class="relativeInput">
													...
													<input class="input inputForm inputFormDadosCasamento" type="text" id="nome1" name="nome1" value="{$valuePessoa.NOME} {$valuePessoa.SOBRENOME}" />
												</div>
												<div class="relativeInput emailConjuge">
													...
													<input class="input inputForm inputFormDadosCasamento" type="text" id="emailNome1" name="emailNome1" value="{$valuePessoa.EMAIL}" />
												</div>
										...
										<div class="sessaoContent">
											<div class="blocoInput clearfix">
												<div class="relativeInput relativeInputFloat">
													...
													<input class="input inputForm inputFormFone" type="text" id="foneDados1" name="foneDados1" value="{$valuePessoa.TELEFONE1}"/>
												</div>
												...
												<div class="relativeInput relativeInputFloat relativeInputMargemLeft2">
													...
													<input class="input inputForm inputFormFone" type="text" id="foneDados3" name="foneDados3" value="{$valuePessoa.CELULAR}" />
												</div>
											</div>
										</div>
									</div>
										...
										<div class="sessaoContent">
											<div class="blocoInput clearfix">
												<div class="relativeInput">
													...
													<input class="input inputForm inputFormLocal" type="text" id="nomeDados" name="nomeDados" value="{$valuePessoa.NOME} {$valuePessoa.SOBRENOME}" />
												</div>
											</div>
											...
											<div class="blocoInput clearfix">
												<div class="relativeInput relativeInputFloat">
													...
													<input class="input inputForm inputFormCepEndereco" type="text" id="cepDados" name="cepDados" value="{$valueEndereco.CEP_ID_CEP}" />
													<span class="formato">
														<a class="linkCep" href="http://www.buscacep.correios.com.br/" target="_blank">N&atilde;o sabe o CEP?</a>
													</span>
												</div>
											...
											<div class="blocoInput clearfix">
												<div class="relativeInput relativeInputFloat">
													...
													<input class="input inputForm inputFormCepEndereco" type="text" id="ruaDados" name="ruaDados" value="{$valueEndereco.ENDERECO}" />
												</div>

												<div class="relativeInput relativeInputFloat relativeInputMargemLeft2">
													<span class="dadosTitulo">*N&uacute;mero</span>
													<label class="label labelForm" for="numeroDados"><!-- 4464 --></label>
													<input class="input inputForm inputFormNumero" type="text" id="numeroDados" name="numeroDados" value="{$valueEndereco.NUMERO}"/>
												</div>
											</div>
											...
											<div class="blocoInput clearfix">
												<div class="relativeInput relativeInputFloat">
													...
													<input class="input inputForm inputFormComplementoBairro" type="text" id="complementoDados" name="complementoDados" value="{$valueEndereco.COMPLEMENTO}" />
												</div>

												<div class="relativeInput relativeInputFloat relativeInputMargemLeft2">
													<span class="dadosTitulo">*Bairro</span>
													<label class="label labelForm" for="bairroDados"><!-- Scharlau --></label>
													<input class="input inputForm inputFormComplementoBairro" type="text" id="bairroDados" name="bairroDados" readonly="readonly" value="{$valueEndereco.BAIRRO}"/>
												</div>
											</div>
											...
											<div class="blocoInput clearfix">
												<div class="relativeInput relativeInputFloat">
													<span class="dadosTitulo">*Estado</span>
													<label class="label labelForm" for="estadoDados"></label>
													<input class="input inputForm inputFormEstado" type="text" name="estadoDados" id="estadoDados" value="{$valueEndereco.UNFE_ID_ESTADO}" readonly="readonly"> 
												</div>

												<div class="relativeInput relativeInputFloat relativeInputMargemLeft2">
													<span class="dadosTitulo">*Cidade</span>
													<label class="label labelForm" for="cidadeDados"><!-- São Leopoldo --></label>
													<input class="input inputForm inputFormCidade" type="text" id="cidadeDados" name="cidadeDados" readonly="readonly" value="{$valueEndereco.NOME_MUNICIPIO}" />
												</div>
											</div>
											...
											<div class="blocoInput clearfix">
												<div class="relativeInput relativeInputFloat">
													...
													<textarea maxlenght="400" id="referenciaDados" name="referenciaDados">{$valueEndereco.REFERENCIA}</textarea>
												</div>
											</div>
