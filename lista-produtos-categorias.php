...
$smarty->assign('nroProdutos', $nroProdutos);
...
$paginaTit = fnPrimeiraMaiuscula($tituloCategoria);
$navegacao = 'Lista de Produtos Categorias';
$menu = 'lista_produtos_categorias';

/*BTG*/
$smarty->assign('nome', $tituloCategoria);
$smarty->assign('categoria', $getCategorias[0]['DESCRICAO_CATEGORIA']);
$smarty->assign('categoria_sub', $getCategorias[1]['DESCRICAO_CATEGORIA']);
$smarty->assign('categoria_sub_sub', $getCategorias[2]['DESCRICAO_CATEGORIA']);
